...
{ keywords: ["worthless", "not enough", "unimportant"], response: "You are incredibly important, even if it doesn't feel like it right now. You’re not alone in this feeling. Let’s talk about what’s making you feel this way." },
...
{ keywords: ["hopeless", "no way out", "giving up"], response: "It may feel like there's no way out right now, but please know that things can get better. Take it one step at a time, and reach out if you need support. I’m here for you." },
...
{ keywords: ["mental health", "depression", "feeling off"], response: "Your mental health is just as important as physical health, and it’s okay to acknowledge when you're struggling. I’m here to talk through it if you need." },
{ keywords: ["can't stop thinking", "mind racing", "too many thoughts"], response: "It’s exhausting when your mind won’t stop. Want to try some grounding techniques or just talk through what’s on your mind?" },
...
{ keywords: ["sad", "depressed", "down"], response: "I'm really sorry you're feeling this way. Want to talk about it?" },
    ...
    { keywords: ["unloved", "not loved","miss","heart break", "no one cares"], response: "You are deeply worthy of love and connection. I care, and I'm here for you." },
...
{ keywords: ["fear", "scared", "terrified", "panic"], response: "Fear is powerful, but you’re stronger. Want to talk through what’s scaring you?" },
